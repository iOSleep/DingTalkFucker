#line 1 "/Users/maxu/code/jailbreak/DingTalkFucker/DingTalkFucker/DingTalkFucker.xm"
...
@class AMapLocationManager; @class DTRedEnvelopServiceFactory; @class DTSectionItem; @class DTWebViewController; @class LLRedEnvelopSettingController; @class LAPluginInstanceCollector; @class DTTableViewDataSource; @class LLSettingController; @class DTInfoPlist; @class DTSettingListViewController; @class DTCellItem; @class DTConversationListDataSource; @class DTTableViewController; 
...
static void _logos_method$_ungrouped$LLRedEnvelopSettingController$tidyDataSource(_LOGOS_SELF_TYPE_NORMAL LLRedEnvelopSettingController* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd){
  ...
  NSArray <NSString *> *titles = @[@"最大延时",@"内容正则",@"名字正则",@"红包类型", @"最低大小"];
  NSArray <NSString *> *hints  = @[@"随机延迟最大秒数",@"对红包内容的正则匹配",@"对发送红包人的正则匹配",@"红包类型，当前1,2,5", @"小于等于该值的红包不抢"];
  NSArray <NSString *> *texts    = @[[@(self.punchConfig.delayTime) stringValue]?:@"",self.punchConfig.regularText?:@"",self.punchConfig.nameregularText?:@"",self.punchConfig.redenvelopTypeText?:@"", self.punchConfig.minimumAcceptAmount?:@"" ];
    ...
    DTCellItem *cellItem = [NSClassFromString(@"DTCellItem") cellItemForEditStyleWithTitle:titles[i] textFieldHint:hints[i] textFieldLimt:NSIntegerMax textFieldHelpBtnNormalImage:nil textFieldHelpBtnHighLightImage:nil textFieldDidChangeEditingBlock:^(DTCellItem *item,DTCell *cell,UITextField *textField){
      switch(i){
        ...
        case 3:
          ...
          break;
        case 4:
          self.punchConfig.minimumAcceptAmount = textField.text;
          break;
      }
    }];
    cellItem.textFieldText = texts[i];
...
#line 470 "/Users/maxu/code/jailbreak/DingTalkFucker/DingTalkFucker/DingTalkFucker.xm"
