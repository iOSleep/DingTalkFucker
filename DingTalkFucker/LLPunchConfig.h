...
@property (nonatomic, copy) NSString *minimumAcceptAmount; ///< 最低接受的红包大小
@property (nonatomic, copy) NSString *regularText;///< 内容的正则表达式
@property (nonatomic, copy) NSString *nameregularText;///< 名字正则表达式
@property (nonatomic, copy) NSString *redenvelopTypeText;//红包的类型,目前支持的是 901,902,905
